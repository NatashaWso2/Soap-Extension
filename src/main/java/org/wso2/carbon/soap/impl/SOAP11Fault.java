...
public class SOAP11Fault {
     ...
     * @throws Exception
     */
    public Element createSOAP11FaultModel(Document doc, DocumentBuilder docBuilder, String namespaceURI) throws Exception {
     ...
     */
    public Element createSOAP11FaultCode(Document doc) {
     ...
     */
    public Element createSOAP11FaultString(Document doc) {
     ...
     */
    public Element createSOAP11FaultDetails(Document doc, DocumentBuilder docBuilder) throws Exception {
